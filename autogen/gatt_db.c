...
{
  0xc6, 0x27, 0x16, 0x93, 0xc1, 0xe8, 0xce, 0xb8, 0x07, 0x41, 0xa1, 0xfc, 0x4d, 0x10, 0x88, 0x52, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_18) = {
  .len = 16,
  .data = { 0x04, 0x83, 0xc1, 0x1c, 0x7f, 0x88, 0x5a, 0xa0, 0xcc, 0x44, 0xf5, 0x2e, 0xff, 0xd3, 0xe4, 0x79, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 18,
  .data = { 0x4c, 0x45, 0x20, 0x56, 0x6f, 0x6c, 0x74, 0x61, 0x67, 0x65, 0x20, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x14, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x10, .char_uuid = 0x8000 } },
  { .handle = 0x15, .uuid = 0x8000, .permissions = 0x800, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
